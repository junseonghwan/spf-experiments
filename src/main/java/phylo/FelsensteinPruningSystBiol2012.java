...
/**
 * Implementation of likelihood calculation as describe in the Appendix of Bouchard-Cote et. al. (2012).
 * 
 * @author seonghwanjun
 *
 */
public class FelsensteinPruningSystBiol2012 implements LikelihoodCalculatorInterface
{
	private EvolutionaryModel<RealVectorParameters> model;
	public FelsensteinPruningSystBiol2012(EvolutionaryModel<RealVectorParameters> model)
	{
		this.model = model;
	}
