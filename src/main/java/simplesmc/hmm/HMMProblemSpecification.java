 ...
 *
 */
public class HMMProblemSpecification implements SMCProblemSpecification<Integer>, WithSignature
{
  ...
  public Pair<Double, Integer> proposeNext(int currentSmcIteration,
      Random random, Integer currentParticle)
  {
    int proposed = parameters.sampleTransition(random, currentParticle);
    double emissionLogPr = parameters.emissionLogPr(proposed, observations.get(currentSmcIteration));
